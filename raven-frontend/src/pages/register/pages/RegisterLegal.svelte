...
<div class="w-full min-h-screen flex flex-col items-center justify-center px-[150px] py-[150px] gap-[150px]">
   <div class="flex flex-col items-center justify-center gap-[10px] w-[50%] z-10">
       <div class="flex flex-col bg-[#171717] p-[30px] rounded-[32px] gap-[20px]">
           ...
           <Text type="p" size={16}>
               By clicking "I AGREE", you acknowledge that you have read and agree to Raven's <a href="/terms" class="hover:text-[#FFFFFF] text-[#A5A7AA] transition-colors duration-300 underline">Terms of Service</a>.
               <br><br>
       ...
       <div class="flex flex-col bg-[#171717] p-[30px] rounded-[32px] gap-[20px]">
           ...
           <Text type="p" size={16}>
               By clicking "I AGREE", you acknowledge that you have read and agree to Raven's <a href="/privacy" class="hover:text-[#FFFFFF] text-[#A5A7AA] transition-colors duration-300 underline">Privacy Policy</a>.
               <br><br>
