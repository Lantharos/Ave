<div class="bg-[#090909] w-full h-screen flex flex-col items-center justify-center px-[200px] py-[100px] gap-[50px]">
    ...
    <p class="text-[#878787] text-[24px] max-w-[80%] text-center">
        It seems you've ventured into uncharted territory. Don't worry, you can head back to the <a href="/#/" class="underline hover:text-[#FFFFFF]">home page</a> or explore our <a href="/#/faq" class="underline hover:text-[#FFFFFF]">FAQ</a> for more information.
    </p>
