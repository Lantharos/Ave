...
export default function FancySelect({options, placeholder = "Select a question", value, onChange, className = ""}: Props) {
    ...
    return (
        <div ref={ref} className={`relative w-full ${className}`}>
            ...
            <button
                type="button"
                className="flex h-[50px] w-full items-center justify-between rounded-[16px] bg-[rgba(32,32,32,0.70)] px-[15px] text-left outline-none border-none font-poppins text-[18px] text-light placeholder:text-muted focus:ring-2 focus:ring-[rgba(138,123,138,0.35)]"
                aria-haspopup="listbox"
                aria-expanded={open}
                onClick={() => setOpen(o => !o)}
                onKeyDown={onKeyDown}
            >
        <span className={selected ? "text-light" : "text-muted"}>
          {selected ? selected.label : placeholder}
                ...
                >
                    <path d="M5.29365 6.70627C5.68428 7.0969 6.31865 7.0969 6.70928 6.70627L11.7093 1.70627C12.0999 1.31565 12.0999 0.681274 11.7093 0.290649C11.3187 -0.0999756 10.6843 -0.0999756 10.2937 0.290649L5.9999 4.5844L1.70615 0.293774C1.31553 -0.0968509 0.681152 -0.0968509 0.290527 0.293774C-0.100098 0.684399 -0.100098 1.31877 0.290527 1.7094L5.29053 6.7094L5.29365 6.70627Z" fill="#878787"/>
                </svg>
            </button>
