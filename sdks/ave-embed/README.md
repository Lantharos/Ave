...
- **`openAppKeyClaimSheet` / `openAppKeyClaimPopup`**: [app key / shared secret](https://docs.aveid.net/guides/shared-secret-transfers) claim flow—recipient accepts an invite inside your app (`payload.kind === "app_key_claim"` on success)
