---
title: "Quickstart"
description: "Register an Ave app, run the OAuth authorization code flow with PKCE, exchange the code, and create your app session."
---
...
<Steps>
  ...
  <Step title="Understand the token response">
    ...
    Ave returns two access tokens with different purposes:
