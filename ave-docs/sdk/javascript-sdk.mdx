...
<CardGroup cols={2}>
  ...
  <Card title="Shared secret functions" icon="key-skeleton" href="/sdk/sdk-shared-secrets">
    `getIdentityEncryptionPublicKey`, `listSharedSecrets`, `getSharedSecretAccess`.
  </Card>
</CardGroup>
