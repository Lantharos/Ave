...
<CardGroup cols={3}>
  ...
  <Card title="Ave Session (smooth sessions)" icon="rotate" href="/guides/ave-session-and-tokens">
    `AveSession`, storage adapters, Convex and Svelte helpers — single-flight refresh.
  </Card>
  ...
  <Card title="Identity keys & wrapped payloads" icon="lock" href="/sdk/sdk-identity-keys">
