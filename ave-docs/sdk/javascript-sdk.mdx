...
<CardGroup cols={2}>
  ...
  <Card title="App keys (shared secrets)" icon="key-skeleton" href="/sdk/sdk-shared-secrets">
    `getIdentityEncryptionPublicKey`, `listSharedSecrets`, `createSharedSecretWithTransfer`, `getSharedSecretAccess`.
  </Card>
</CardGroup>
