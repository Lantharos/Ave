---
title: "@ave-id/sdk"
description: "Typed helpers for Quick Ave, OAuth, Connector delegation, Signing, and framework session integrations."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Business workspaces" icon="building" href="/guides/business-workspaces">
    `organizationId`, org-context tokens, `getAveWorkspaceContext`, workspace permissions.
  </Card>
