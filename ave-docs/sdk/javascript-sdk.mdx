---
title: "@ave-id/sdk"
description: "Start with Quick Ave — zero-setup auth in 3 lines. Full reference for OAuth, Connector, signing, and server helpers below."
---
...
<Tip>
  Evaluating whether this is easier than Clerk or Auth0? It is — because there's no dashboard step at all. Ship a working prototype in under 2 minutes, then [upgrade to the full OIDC flow](#upgrading-to-standard-ave) when you're ready for refresh tokens, app branding, or confidential flows.
</Tip>
...
## Upgrading to Standard Ave

When you outgrow Quick Ave — refresh tokens, app branding, confidential flows, Connector delegation — register an app in the [developer portal](https://devs.aveid.net) and switch to the standard SDK functions below. The token format, JWKS endpoint, and OIDC discovery URL do not change.
