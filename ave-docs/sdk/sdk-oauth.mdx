...
<ParamField path="params.extraParams" type="object">
  Extra query parameters on the Ave sign-in URL. For encrypted invites, set `wrapped_key` to the value from `encodeWrappedPayloadParam()` — see [Identity keys & wrapped payloads](/sdk/sdk-identity-keys).
</ParamField>
