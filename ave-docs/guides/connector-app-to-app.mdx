...
description: "Delegated app-to-app access using the token-exchange grant. Covers the consent flow, token exchange, delegated JWT payload, and token validation on the target resource."
---
