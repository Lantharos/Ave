...
<CardGroup cols={3}>
  ...
  <Card title="Shared Secrets" icon="key-skeleton" href="/api/shared-secret-endpoints">
...
All request bodies are JSON. The token endpoint uses **camelCase** field names.
...
<AccordionGroup>
  ...
  <Accordion title="Shared secret endpoints — session auth plus public lookup">
    Public endpoints:
