...
<div class="flex flex-col md:flex-row w-full rounded-[20px] md:rounded-[36px] overflow-hidden gap-0 md:gap-[10px]">
    ...
    <div class="flex flex-row gap-0 md:gap-[20px]">
        {#each buttons as button}
            <button
                    class="flex flex-row items-center justify-center flex-1 md:flex-none md:aspect-square w-fit px-5 md:px-[40px] py-4 md:py-[10px] bg-[#171717] text-[18px] hover:bg-[#202020] transition-colors duration-300 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed"
