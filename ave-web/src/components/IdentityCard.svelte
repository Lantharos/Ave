        ...
        {#if editable}
            <div class="color-picker-container">
                <button 
                    ...
                    class="w-[30px] h-[30px] md:w-[40px] md:h-[40px] rounded-[10px] md:rounded-[15px] bg-[#202020]/70 flex flex-col items-center justify-center absolute bottom-2 md:bottom-[10px] right-2 md:right-[10px] hover:bg-[#202020]/90 transition-colors duration-300 cursor-pointer z-10"
    ...
    <div class="{size === 'small' ? 'w-[80px] h-[80px] md:w-[125px] md:h-[125px]' : 'w-[90px] h-[90px] md:w-[160px] md:h-[160px]' } overflow-hidden mt-[20px] md:mt-[40px] ml-3 md:ml-[40px] z-10 absolute">
        ...
        {#if editable}
            <button 
                ...
                class="w-[28px] h-[28px] md:w-[36px] md:h-[36px] rounded-[8px] md:rounded-[12px] bg-[#202020]/70 flex flex-col items-center justify-center absolute bottom-2 md:bottom-[15px] right-2 md:right-[20px] hover:bg-[#202020]/90 transition-colors duration-300 cursor-pointer"
