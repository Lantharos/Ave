<script lang="ts">
  ...
  import AppsPage from "./sections/AppsPage.svelte";
  import TeamPage from "./sections/TeamPage.svelte";
  import CreateAppPage from "./sections/CreateAppPage.svelte";
  import AppDetailPage from "./sections/AppDetailPage.svelte";
  import AppOverviewPage from "./sections/AppOverviewPage.svelte";
  import AppIdentitiesPage from "./sections/AppIdentitiesPage.svelte";
  import AppActivityPage from "./sections/AppActivityPage.svelte";
