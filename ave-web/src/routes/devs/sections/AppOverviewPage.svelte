<script lang="ts">
  ...
  import type { AppEvent, AppIdentityRecord, AppInsightSnapshot, DevApp } from "$lib/surfaces/devs/lib/api";
  import { formatDateTime, formatPercent, formatRelativeTime, getActivityLabel, getActivityTone } from "$lib/surfaces/devs/lib/portal";
