<script lang="ts">
  ...
  import type { AppIdentityRecord } from "$lib/surfaces/devs/lib/api";
  import { formatDate, formatRelativeTime, getAuthMethodLabel, getInitials, shortId } from "$lib/surfaces/devs/lib/portal";
