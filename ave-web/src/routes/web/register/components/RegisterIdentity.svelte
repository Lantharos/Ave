...
<div class="w-full max-w-[760px] md:max-w-none mx-auto min-h-screen-fixed flex flex-col items-center justify-center px-6 md:px-[150px] py-12 md:py-[150px] gap-8 md:gap-[150px] overflow-auto scroll-smooth">
        ...
        >
            <div class="flex flex-col gap-2 md:gap-[10px]">
                <div class="p-5 md:p-[30px] bg-[#111111] rounded-[24px] md:rounded-[32px]">
                    ...
                    <input 
                        type="text" 
                        class="w-full bg-transparent border-b border-[#333333] mt-2 md:mt-[10px] pb-[5px] text-white caret-white placeholder:text-[#555] focus:outline-none text-base md:text-inherit appearance-none"
                ...
                <div class="p-5 md:p-[30px] bg-[#111111] rounded-[24px] md:rounded-[32px]">
                    ...
                    <input 
                        type="text" 
                        class="w-full bg-transparent border-b mt-2 md:mt-[10px] pb-[5px] text-white caret-white placeholder:text-[#555] focus:outline-none text-base md:text-inherit appearance-none {handleError ? 'border-red-500' : 'border-[#333333]'}" 
                        style="color: #FFFFFF; caret-color: #FFFFFF;"
