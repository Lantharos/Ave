    ...
    {:else}
        <div class="flex flex-col gap-4">
            {#each requests as request}
                <div class="p-6 bg-[#171717] rounded-[32px] flex flex-col gap-4">
                    <div class="flex items-start justify-between">
                        <div class="flex items-center gap-4">
                            <div class="w-12 h-12 bg-[#222] rounded-full flex items-center justify-center">
                    ...
                    <div class="flex gap-3">
                        <button 
                            class="flex-1 px-6 py-3 bg-[#FFFFFF] hover:bg-[#E0E0E0] text-[#090909] rounded-full font-semibold transition-colors disabled:opacity-50"
                        ...
                        <button 
                            class="flex-1 px-6 py-3 bg-red-600/20 hover:bg-red-600/40 text-red-400 rounded-full font-semibold transition-colors disabled:opacity-50"
