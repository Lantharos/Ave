...
<div class="bg-[#090909] w-full h-screen-fixed flex flex-col items-center justify-center overflow-auto hide-scrollbar relative">
    {#if error}
    ...
    <AuroraBackdrop preset="login" mobileHeight={360} cclass="absolute bottom-0 left-0 w-full pointer-events-none select-none" />
</div>
