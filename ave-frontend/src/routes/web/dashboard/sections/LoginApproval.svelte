<script lang="ts">
    ...
    import { api, type LoginRequest } from "$lib/surfaces/web/lib/api";
    ...
    import { loadMasterKey, encryptMasterKeyForDevice, generateEphemeralKeyPair } from "$lib/surfaces/web/lib/crypto";
