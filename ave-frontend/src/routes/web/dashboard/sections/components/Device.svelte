<script lang="ts">
    import type { Device as DeviceType } from "$lib/surfaces/web/lib/api";
    import { Laptop, Smartphone, Tablet, X } from "@lucide/svelte";
    ...
    function iconForDevice(type?: string) {
...
<div class="grid h-[268px] grid-rows-[1fr_54px] overflow-hidden rounded-[24px] bg-[#171717] shadow-[0_24px_60px_rgba(0,0,0,0.18)] md:h-[290px] md:rounded-[26px]">
    <div class="flex min-h-0 flex-col items-center justify-center px-5 py-6 text-center md:px-6 md:py-7">
        <DeviceIcon class="h-11 w-11 shrink-0 text-white/80 md:h-[52px] md:w-[52px]" size={52} strokeWidth={2.5} />
