<script lang="ts">
    ...
    import type { ActivityLogEntry } from "$lib/surfaces/web/lib/api";
    ...
    function formatAction(action: string): string {
        const actionMap: Record<string, string> = {
            ...
            "trust_code_used": "Recovery Code Used",
            "trust_codes_created": "Recovery Codes Created",
            "trust_codes_regenerated": "Recovery Codes Regenerated",
