...
<div class="bg-[#090909] w-full min-h-screen-fixed flex flex-col items-start px-6 md:px-[200px] py-12 md:py-[100px] gap-12 md:gap-[100px] relative overflow-auto">
    <button 
    ...
    {#if mobileMenuOpen}
        <div class="mobile-nav-overlay">
            <a href={resolve("/" as any)} class="px-6 py-3 bg-[#171717] rounded-full text-[#B9BBBE] text-lg" onclick={() => mobileMenuOpen = false}>
                about
            </a>
            <a href={resolve("/login" as any)} class="px-6 py-3 text-[#B9BBBE] text-lg" onclick={() => mobileMenuOpen = false}>
                login
            </a>
            <a href={resolve("/register" as any)} class="px-6 py-3 text-[#B9BBBE] text-lg" onclick={() => mobileMenuOpen = false}>
                new id
            </a>
            ...
            <a href={resolve("/privacy" as any)} class="text-[#A5A7AA] text-base" onclick={() => mobileMenuOpen = false}>
                privacy policy
            </a>
            <a href={resolve("/terms" as any)} class="text-[#A5A7AA] text-base" onclick={() => mobileMenuOpen = false}>
                terms of service
            </a>
        </div>
    {/if}
    ...
    <div class="hidden md:flex flex-row w-full justify-between items-start desktop-nav">
        <div class="flex flex-row">
            ...
            <a href={resolve("/login" as any)} class="px-[40px] py-[20px] cursor-pointer hover:bg-[#121212] transition-colors duration-300 rounded-full flex items-center justify-center text-[#B9BBBE] text-[24px]">
                login
            </a>
            <a href={resolve("/register" as any)} class="px-[40px] py-[20px] cursor-pointer hover:bg-[#121212] transition-colors duration-300 rounded-full flex items-center justify-center text-[#B9BBBE] text-[24px]">
                new id
            </a>
        ...
        <div class="flex flex-col items-end justify-end">
            <a href={resolve("/privacy" as any)} class="cursor-pointer hover:text-[#FFFFFF] hover:underline transition-all duration-300 rounded-full flex items-center justify-center text-[#A5A7AA] text-[24px]">
                privacy policy
            </a>
            <a href={resolve("/terms" as any)} class="cursor-pointer hover:text-[#FFFFFF] hover:underline transition-all duration-300 rounded-full flex items-center justify-center text-[#A5A7AA] text-[24px]">
                terms of service
            </a>
        </div>
    </div>

    <div class="flex flex-col w-full items-start justify-center gap-2 md:gap-[10px] z-10 mt-8 md:mt-0">
        <h1 class="font-bold text-white text-4xl md:text-[96px]">
            Meet Ave.
        </h1>
