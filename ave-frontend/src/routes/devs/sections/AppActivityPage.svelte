<script lang="ts">
  ...
  import type { AppEvent, AppInsightSnapshot, DevApp } from "$lib/surfaces/devs/lib/api";
  import { formatDateTime, formatRelativeTime, getActivityLabel, getActivityTone } from "$lib/surfaces/devs/lib/portal";
      ...
      <div class="flex flex-col gap-5">
        ...
        <div class="flex flex-col gap-3">
          {#if actionCounts.length}
            {#each actionCounts as [action, count] (action)}
