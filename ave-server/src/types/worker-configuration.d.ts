/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-file=.dev.vars.example --strict-vars=false src/types/worker-configuration.d.ts` (hash: b34beb7f31c3104e6869783949c90573)
// Runtime types generated with workerd@1.20260903.1 2026-08-26 nodejs_compat
interface __BaseEnv_Env {
	UPLOADS: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	API_ANALYTICS: AnalyticsEngineDataset;
	BACKGROUND_EVENTS: Queue;
	OAUTH_TOKEN_IP_RATE_LIMITER: RateLimit;
	OAUTH_AUTHORIZE_ACTOR_RATE_LIMITER: RateLimit;
	OAUTH_CLIENT_RATE_LIMITER: RateLimit;
	RP_ID: string;
	RP_NAME: string;
	RP_ORIGIN: string;
	...
	OIDC_ISSUER: string;
	OIDC_RESOURCE_AUDIENCE: string;
	OIDC_DISCOVERY_BASE: string;
	OIDC_KID: string;
	OIDC_PRIVATE_KEY_PEM: string;
	OIDC_PUBLIC_KEY_PEM: string;
	BUSINESS_SSO_SECRET_KEY: string;
	SESSION_SECRET: string;
	DEV_PORTAL_CLIENT_ID: string;
	DEMO_HANDLE: string;
	...
	API_APP: DurableObjectNamespace<import("../index").ApiAppDurableObject>;
	RATE_LIMITER: DurableObjectNamespace<import("../index").RateLimitDurableObject>;
	HEAVY_SERVICES: Fetcher /* ave-heavy-services */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("../index");
		durableNamespaces: "ApiAppDurableObject" | "RateLimitDurableObject";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RP_ID" | "RP_NAME" | "RP_ORIGIN" | "COOKIE_DOMAIN" | "COOKIE_SECURE" | "BUSINESS_ORIGIN" | "INTERNAL_API_TOKEN" | "OIDC_ISSUER" | "OIDC_RESOURCE_AUDIENCE" | "OIDC_DISCOVERY_BASE" | "OIDC_KID" | "OIDC_PRIVATE_KEY_PEM" | "OIDC_PUBLIC_KEY_PEM" | "BUSINESS_SSO_SECRET_KEY" | "SESSION_SECRET" | "DEV_PORTAL_CLIENT_ID" | "DEMO_HANDLE" | "DEMO_PASSWORD" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY" | "VAPID_SUBJECT" | "EMAIL_FROM_ADDRESS" | "EMAIL_FROM_NAME" | "R2_PUBLIC_URL">> {}
}
